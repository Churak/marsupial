...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_capabilities_SOURCE_PREFIX /home/jared/marsupial/client/src/kobuki/kobuki_capabilities)
  set(kobuki_capabilities_DEVEL_PREFIX /home/jared/marsupial/client/devel)
  ...
  set(kobuki_capabilities_INSTALL_PREFIX /home/jared/marsupial/client/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'kobuki_capabilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jared/marsupial/client/src/kobuki/kobuki_capabilities/${idir}'.  Ask the maintainer 'Marcus Liebhardt <marcus.liebhardt@yujinrobot.com>' to fix it.")
    endif()
