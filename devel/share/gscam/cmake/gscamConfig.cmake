...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/marsupial/marsupial/src/gscam)
  set(gscam_DEVEL_PREFIX /home/marsupial/marsupial/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/marsupial/marsupial/install)
...
if(NOT "/home/marsupial/marsupial/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/i386-linux-gnu/glib-2.0/include;/usr/include/libxml2" STREQUAL "")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/marsupial/marsupial/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/i386-linux-gnu/glib-2.0/include;/usr/include/libxml2")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marsupial/marsupial/src/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
